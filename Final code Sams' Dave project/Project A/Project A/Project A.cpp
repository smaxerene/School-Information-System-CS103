...
void ParentMmScreen()
{
    ...
    char choice = 0, ye = 'y', decline = 'n', teach= 't';
    cout << "Welcome, " << ParentInfo.fiName << " " << ParentInfo.laName << "!\n\n";
    cout << "Would you like to see your Sons'/Daughters' Report?\n\n";

redo:
    cout << "  y / n?: \n";
    cout << "Press t for Admin to ( update report for student ) menu: ";
    cin >> choice;
    ...
    else if (choice == teach)
    {
        ...
        cout << "Wrong word/letter, Please Try Agin!";
        goto redo;
    }
}
...
void TeaRep()
{
    ...
    char choice = 0, finishy = 'y', finishn = 'e', parent = 'p';
...
again:
    ...
    cout << "Press p to login as Parent Gaurdian :  ";
    cin >> choice;
...
redo:
    ...
    {
        ParentMmScreen();//Parent Menu Screen
    }
    else {
        cout << "Wrong letter, Please Try again: ";
        goto redo;
