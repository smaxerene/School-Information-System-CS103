...
//Prototype
void line();
void admInfoInp(); //getting info of admin
void studInfoInp(); //getting Info of studen
void passReg(); //password register
void teaLogin();// login for teacher
void stuLogin(); //login for student

void TeaMmScreen(); //Menu for Teacher
void StuMmScreen(); //Menu for student
void teaStuInf(); // Teacher student information
void stuStuInf(); // student information
void teaTeaInf(); // Teacher Information
void StuTeaInf(); //to do // student teacher Information
void TeaRep(); //to do //Teacher Report
void TeachDisplay();
void StuRep(); // to do // Student Report
...
void StuMmScreen()
{
    ...
    while (!exitCondition)
    {
        ...
        cout << "\nThank you for using our  number one application!\n\n";
        cout << "Program Ended\n";
    }
}
